...
export const spanishContent = {
    ...
    testimonials: [
        ...
        },
        {
            reviewerName: "Andrew C",
            imgSrc: andrew,
            reviewText: `Un restaurante tan maravilloso que tuve mi cena de ensayo de boda aquí. No era lujoso, pero la comida, las bebidas y el servicio se fusionaron perfectamente. El dueño y el personal son geniales y la comida es excelente. Mi único arrepentimiento es que no vengo aquí lo suficiente.

            Algunos podrían decir que es un restaurante 'pequeño y acogedor', pero eso es un elogio para este lugar. Es fantástico.
        ...
        },
        {
            reviewerName: "Farrah K",
            imgSrc: farrah,
            reviewText: `¡Excelente lugar pequeño! Tenía antojo de ceviche y esto apareció. ¡Delicioso! Todo es genial: ceviche, totopos, guacamole y empanadas. Sabores sorprendentes de la comida latinoamericana. Definitivamente, échale un vistazo.
